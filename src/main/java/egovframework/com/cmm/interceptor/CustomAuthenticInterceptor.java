...
public class CustomAuthenticInterceptor implements HandlerInterceptor { //extends HandlerInterceptorAdapter : spring version 이 5.3 이상 HandlerInterceptor implements 로 변경
